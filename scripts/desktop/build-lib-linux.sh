...
patchelf --remove-needed "libffi.so.7" libHSsimplex-chat-*-inplace-ghc${GHC_VERSION}.so
patchelf --add-needed "libffi.so.8" libHSsimplex-chat-*-inplace-ghc${GHC_VERSION}.so
